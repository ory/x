...
func ParseOptions(l *logrusx.Logger, prefix string) cors.Options {
	prefix = p(prefix)
	return cors.Options{
...
func IsEnabled(l *logrusx.Logger, prefix string) bool {
	prefix = p(prefix)
...
func Initialize(h http.Handler, l *logrusx.Logger, prefix string) http.Handler {
