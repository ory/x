...
// Source: github.com/ory/x/hashersx (interfaces: Argon2Configurator)
...
func (m *MockArgon2Configurator) HasherArgon2Config(arg0 context.Context) *hashersx.Argon2Config {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasherArgon2Config", arg0)
	ret0, _ := ret[0].(*hashersx.Argon2Config)
	return ret0
}
