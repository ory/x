...
// Source: github.com/ory/x/hashersx (interfaces: BCryptConfigurator)
...
func (m *MockBCryptConfigurator) HasherBcryptConfig(arg0 context.Context) *hashersx.BCryptConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasherBcryptConfig", arg0)
	ret0, _ := ret[0].(*hashersx.BCryptConfig)
	return ret0
}
