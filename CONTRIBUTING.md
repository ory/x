...
won't clash or be obviated by ORY X's normal direction. A great way to
do this is via
[ORY X Discussions](https://github.com/ory/X/discussions) or
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  X. Github stars help the project gain visibility and stand out.
...
Check out
[ORY X Discussions](https://github.com/ory/X/discussions).
...
[docs](https://github.com/ory/X/tree/master/docs) folder. Generate API
...
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/X.git
