...
func TestAnonymizePath(t *testing.T) {
	...
	assert.Equal(t, "/keys/837b4168b57215f2ba0d4e64e57a653d6a6ecd6065e78598283209467d172373", anonymizePath(w, "/keys/1234", "somesupersaltysalt"))
	assert.Equal(t, "/keys", anonymizePath(w, "/keys", "somesupersaltysalt"))
}
