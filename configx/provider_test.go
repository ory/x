	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			isValid: true, envs: [][2]string{
				{"SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS_GOOGLE_CLIENT_ID", `googleclient@example.com`},
				{"SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS_GOOGLE_CLIENT_SECRET", `googlesecret`},
				{"SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS_APPLE_CLIENT_ID", `appleclient@example.com`},
				{"SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS_APPLE_CLIENT_SECRET", `applesecret`},
