...
func TestReadFileFromAllSources(t *testing.T) {
	...
	for k, tc := range []struct {
		...
		{src: "base64://aGVsbG8gd29ybGQ", expectedErr: "base64 loader disabled", opts: []Option{WithDisableBase64Loader()}},
		...
		{src: "file://stub/text.txt", expectedErr: "file loader disabled", opts: []Option{WithDisableFileLoader()}},
		...
		{src: sslTS.URL, expectedErr: "http(s) loader disabled", opts: []Option{WithDisableHTTPLoader()}},
